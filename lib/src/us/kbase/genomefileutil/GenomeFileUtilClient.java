...
public class GenomeFileUtilClient {
     ...
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.genomefileutil.GenbankToGenomeParams GenbankToGenomeParams}
     * @return   parameter "result" of type {@link us.kbase.genomefileutil.GenomeSaveResult GenomeSaveResult}
    ...
    public GenomeSaveResult genbankToGenome(GenbankToGenomeParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<GenomeSaveResult> res = caller.jsonrpcCall("GenomeFileUtil.genbank_to_genome", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
     ...
     * <pre>
     * </pre>
     * @param   params   instance of type {@link us.kbase.genomefileutil.GenomeToGFFParams GenomeToGFFParams}
     * @return   parameter "result" of type {@link us.kbase.genomefileutil.GenomeToGFFResult GenomeToGFFResult}
     * @throws IOException if an IO exception occurs
     * @throws JsonClientException if a JSON RPC exception occurs
     */
    ...
    public ExportOutput exportGenomeAsGenbank(ExportParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<ExportOutput> res = caller.jsonrpcCall("GenomeFileUtil.export_genome_as_genbank", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("GenomeFileUtil.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
