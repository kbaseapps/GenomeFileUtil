...
class Application(object):
    ...
    def __init__(self):
        ...
        self.rpc_service.add(impl_GenomeFileUtil.genbank_to_genome,
                             ...
                             types=[dict])
        self.method_authentication['GenomeFileUtil.genbank_to_genome'] = 'required'
        ...
        self.rpc_service.add(impl_GenomeFileUtil.TranslateNucToProtSeq,
                             name='GenomeFileUtil.TranslateNucToProtSeq',
                             types=[dict])
        self.method_authentication['GenomeFileUtil.TranslateNucToProtSeq'] = 'required'
        self.rpc_service.add(impl_GenomeFileUtil.GenomeToFASTA,
                             name='GenomeFileUtil.GenomeToFASTA',
                             types=[dict])
        self.method_authentication['GenomeFileUtil.GenomeToFASTA'] = 'required'
        self.rpc_service.add(impl_GenomeFileUtil.GenomeSetToFASTA,
                             name='GenomeFileUtil.GenomeSetToFASTA',
                             types=[dict])
        self.method_authentication['GenomeFileUtil.GenomeSetToFASTA'] = 'required'
        self.rpc_service.add(impl_GenomeFileUtil.FeatureSetToFASTA,
                             name='GenomeFileUtil.FeatureSetToFASTA',
                             types=[dict])
        self.method_authentication['GenomeFileUtil.FeatureSetToFASTA'] = 'required'
                    ...
                    if auth_req != "none":
                        if token is None and auth_req == 'required':
                            ...
                            err.data = "Authentication required for " + \
                                "GenomeFileUtil but no authentication header was passed"
                            raise err
